...
VMATHDEF scalar quat_norm(quat *v); // vec4_lenqsr
...
VMATHDEF void mat3x4_from_qst(mat3x4 *m, quat *q, vec3 *s, vec3 *t)
{
	scalar x = q->x, y = q->y, z = q->z, w = q->w;
